        ...
        <form onSubmit={handleAddCategory} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-400 focus:bg-white font-semibold text-slate-700 transition-all"
            >
